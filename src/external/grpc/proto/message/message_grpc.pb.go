...
const (
	BotService_SendInviteLink_FullMethodName = "/message_proto.BotService/SendInviteLink"
)
...
type BotServiceClient interface {
	SendInviteLink(ctx context.Context, in *SendInviteLinkRequest, opts ...grpc.CallOption) (*SendInviteLinkReply, error)
}
...
func (c *botServiceClient) SendInviteLink(ctx context.Context, in *SendInviteLinkRequest, opts ...grpc.CallOption) (*SendInviteLinkReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendInviteLinkReply)
	err := c.cc.Invoke(ctx, BotService_SendInviteLink_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BotServiceServer interface {
	SendInviteLink(context.Context, *SendInviteLinkRequest) (*SendInviteLinkReply, error)
...
func (UnimplementedBotServiceServer) SendInviteLink(context.Context, *SendInviteLinkRequest) (*SendInviteLinkReply, error) {
...
func _BotService_SendInviteLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendInviteLinkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BotServiceServer).SendInviteLink(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BotService_SendInviteLink_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BotServiceServer).SendInviteLink(ctx, req.(*SendInviteLinkRequest))
	}
...
var BotService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "message_proto.BotService",
	HandlerType: (*BotServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendInviteLink",
			Handler:    _BotService_SendInviteLink_Handler,
		},
	},
